...
export default function Toapply() {
  ...
  const handlSupmit = () => {
    if (studentName.length === 0) {
      ...
      const url = "http://localhost/phpexmaple/TMEMAHOUD.php";
  ...
  return<>
        <section className="applay  ">
        <div className="layot">
          <h1 className="text-main fw-bolder">Apply Now</h1>
        </div>
      </section>
        <section>
      ...
      <form className="w-75 mx-auto p-5  ">
        ...
        <div className="row p-3 ">
          ...
          <button
            type="button"
            onClick={() => handlSupmit()}
            className=" w-100 mx-auto btn btn-outline-primary fw-bold"
          >
            Send Data
          </button>
        </div>
